...
ShipFactory::andreaDoriaBuilder(sf::Vector2i &coordinates) const {
    ...
    AndreaDoria->attach(std::move(factory.createHeavly(cannonPosX + 7, cannonPosY + 40, *AndreaDoria)));
    AndreaDoria->attach(std::move(factory.createHeavly(cannonPosX + 7, cannonPosY + 54, *AndreaDoria)));
    AndreaDoria->attach(std::move(factory.createHeavly(cannonPosX + 7, cannonPosY + 118, *AndreaDoria)));
    AndreaDoria->attach(std::move(factory.createHeavly(cannonPosX + 7, cannonPosY + 132, *AndreaDoria)));
