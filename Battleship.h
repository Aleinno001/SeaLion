...
public:
    ...
    Battleship(int x, int y, float ac, const float maxVel, int hp, int length, int arm, std::string na,
               ...
               bool col, std::string textureName, ShipType sh, ModelType mo, int numInterceptors);
