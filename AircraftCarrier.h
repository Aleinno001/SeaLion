...
private:
    int numPlanes;
public:
    AircraftCarrier(int x, int y, float ac, const float maxVel, int hp, int length, int arm, std::string na,
                    ...
                    bool col, std::string textureName, ShipType sh, ModelType mo, int planes) : WarShip(x, y, ac,
                                                                                                        maxVel, hp,
                                                                                                        length, arm, na,
                                                                                                        nat, numL, numH,
                                                                                                        numM,
