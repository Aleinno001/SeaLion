...
Battleship::Battleship(int x, int y, float ac, const float maxVel, int hp, int length, int arm, std::string na,
                       ...
                       int wi, bool col, std::string textureName, ShipType sh, ModelType mo, int numInter) : WarShip(x,
                                                                                                                     y,
                                                                                                                     ac,
                                                                                                                     maxVel,
                                                                                                                     hp,
