...
std::unique_ptr<ConcreteArsenal> CannonFactory::createLight(int posX, int posY, WarShip &subject){
    ...
    std::unique_ptr<ConcreteArsenal> lightCannon(new ConcreteArsenal(350, 12, 20, b, 200, 6, 4, "LightCannon", subject, posX, posY));
...
std::unique_ptr<ConcreteArsenal> CannonFactory::createMedium(int posX, int posY, WarShip &subject){
    ...
    std::unique_ptr<ConcreteArsenal> mediumCannon(new ConcreteArsenal(450, 24, 28, b, 200, 14, 7,"MediumCannon", subject, posX, posY));
